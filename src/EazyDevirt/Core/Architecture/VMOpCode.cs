...
internal record VMOpCode(SerializedFieldDefinition SerializedInstructionField = null!,
    SerializedMethodDefinition SerializedDelegateMethod = null!)
{
    ...
    public CilOperandType CilOperandType
    {
        get
        {
            return VirtualOperandType switch
            {
                ...
                _ => throw new ArgumentOutOfRangeException(nameof(VirtualOperandType), VirtualOperandType,
    ...
    {
        return $"VirtualCode: {VirtualCode} | OperandType: {CilOperandType} ({VirtualOperandType}) | " +
