...
internal interface IPattern
{
    ...
    bool Verify(MethodDefinition method, int index = 0)
    {
        return Verify(method.CilMethodBody!.Instructions, index);
    }
    ...
    /// <param name="index">Index of the pattern</param>
    /// <returns>Whether verification is successful</returns>
    bool Verify(CilInstructionCollection instructions, int index = 0)
    {
        return true;
    }
}