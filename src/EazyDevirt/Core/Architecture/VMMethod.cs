...
internal record VMMethodInfo
{
    ...
    {
        get { return (BindingFlags & 2) > 0; }
    }

    public bool IsInstance
    {
        get { return (BindingFlags & 4) > 0; }
    }

    public bool IsStatic
    {
        get { return (BindingFlags & 8) > 0; }
    }
    ...
    public override string ToString()
    {
        return $"VMDeclaringType: 0x{VMDeclaringType:X} | Name: {Name} | BindingFlags: {BindingFlags} | " +
...
internal record VMParameter(int VMType, bool In)
{
    ...
    public override string ToString()
    {
        return $"VMType: 0x{VMType:X} | In: {In}";
    }
}